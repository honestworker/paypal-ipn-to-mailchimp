 ...
 * @subpackage Paypal_Ipn_To_Mailchimp/admin
 */
 ...
 */
class Paypal_Ipn_To_Mailchimp_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/paypal-ipn-to-mailchimp-admin.css', array(), $this->version, 'all' );
